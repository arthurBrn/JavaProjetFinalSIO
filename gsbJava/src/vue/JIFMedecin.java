...
public class JIFMedecin extends JInternalFrame  {
    ...
    /*
     * Le code bug car : 
     * des attributs de medecin ont été déplacé dans personne 
     * Le nombre d'éléments qu'on essayer d'afficher dans cette vue n'est pas le même que dans le constructeur de medecin
     * 
     */
    ...
    {  // méthode qui permet de remplir les zones de texte à partir des valeurs passées en paramètres
    	...
    	JTcode.setText(unMedecin.getCodePersonne());        
        JTnom.setText(unMedecin.getNomPersonne());
        JTprenom.setText(unMedecin.getPrenomPersonne());
        ...
        JTspecialite.setText(unMedecin.getLaSpecialite().toString());
     }
