...
public class JIFMiseAJourVisite extends JInternalFrame{
	...
	public JIFMiseAJourVisite(){
		...
		mButton.add(JBmodifier);		
	     ...
	     Object[][] data = {
	    		 {"Médicament 1", JTdepotLegal.getText(), JTquantiteOfferte.getText()},
	    			 {"Médicament 2", JTdepotLegal.getText(), JTquantiteOfferte.getText()},
	};
